...
A pipeline for detecting **gender bias** and **discriminatory language** in textual content (research projects, job postings, academic papers, PDFs). It supports **English** and **Spanish** and offers two complementary detection approaches:
